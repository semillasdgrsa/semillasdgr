...
VARIEDADES = [
    ...
    },
    {
        ...
        "descripcion": (
            ...
            "Semilla certificada BHN Seed, origen India."
        ),
        "specs": [
            ("Germinación",   "90%"),
            ("Pureza",        "99%"),
    ...
    },
    {
        ...
        "bhn": False,
        "fotos": [
            foto("0154", "0154-campo-08.jpeg"),
            foto("0154", "0154-campo-07.jpeg"),
            foto("0154", "0154-campo-05.jpeg"),
            foto("0154", "0154-campo-14.jpeg"),
            foto("0154", "0154-campo-12.jpeg"),
        ],
    },
]
...
def draw_page(c, variedad, page_num, total):
    ...
    c.drawString(MARGIN, foot_h - 21*mm, "CR: +506 7053-6966  |  PTY: +507 6447-1230")
...
def draw_cover_page(c, variedades=None, titulo="CATÁLOGO DE FICHAS TÉCNICAS"):
    ...
    c.drawString(text_x, foot_h - 18.5*mm, "CR: +506 7053-6966  |  PTY: +507 6447-1230")
    c.drawRightString(W - MARGIN, foot_h - 6*mm,  "semillas-dgr.com")
